...
class ORTModule(torch.nn.Module):
    ...
    def forward(self, *input, **kwargs):
        ...
        # print(f'Outputs: {self._onnx_forward_outputs_desc}')
        ...
        class _ORTModuleFunction(torch.autograd.Function):
            ...
            def forward(ctx, *input, **kwargs):
                ...
                outputs = self._run_forward_graph(input_with_initializer)  # inputs, weights)
            ...
            def backward(ctx, *grad_output):
                ...
                # grad_inputs, grad_weights = self._run_backward_graph(*[*saved_tensors, *grad_output])
